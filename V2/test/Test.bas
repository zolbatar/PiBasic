...
REM PRINT "LET                = ";;:LETA=1:If A = 1 Then Print "PASS" Else PROCFail()
Print
...
Next
Data 1, 2, 3, 4, 5
Print "Data (Array)       = ";;:If data%(0) + data%(1) + data%(2) + data%(3) + data%(4) = 15 Then Print "PASS" Else PROCFail()
...
180 GOSUB%=0
210 GOSUB 300
220 If GOSUB%=1 Then PRINT "PASS" ELSE PROCFail()
