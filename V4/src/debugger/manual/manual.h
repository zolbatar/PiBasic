...
public:
    ...
    {
        g_graphics->cursor_back(fixed_font);
    }
};
...
public:
    ...
    void render() override
    {
        g_graphics->colour(100, 100, 255);
        g_graphics->print_text(fixed_font, "<expression" + std::to_string(sequence) + ">", -1, -1);
    }
...
public:
    ...
    {
        g_graphics->colour(100, 100, 255);
        g_graphics->print_text(fixed_font, "<numeric_expression" + std::to_string(sequence) + ">", -1, -1);
    }
...
public:
    ...
    {
        g_graphics->colour(100, 100, 255);
        g_graphics->print_text(fixed_font, "<string_expression" + std::to_string(sequence) + ">", -1, -1);
    }
...
public:
    ...
    {
        g_graphics->colour(100, 100, 255);
        g_graphics->print_text(fixed_font, "<variable" + std::to_string(sequence) + ">", -1, -1);
    }
...
public:
    ...
    {
        g_graphics->colour(100, 100, 255);
        g_graphics->print_text(fixed_font, "<numeric_variable" + std::to_string(sequence) + ">", -1, -1);
    }
...
public:
    ...
    void render() override
    {
        ...
        g_graphics->print_text(fixed_font, "[" + text + "]", -1, -1);
    }
