...
void Compiler::compile_node_variable_expression(struct AST* ast)
{
    ...
    case Type::REAL:
        ...
        break;
    case Type::STRING:
        vm->insert_instruction(line_number, file_number, write, Bytecodes::LOAD_S, var_id);
        stack_push(var_type);
        break;
    case Type::TYPE: {
        // Find the variable
        ...
        vm->insert_instruction(line_number, file_number, write, Bytecodes::CONST_I, c.field_id);
        insert_instruction_based_on_type(
            {
