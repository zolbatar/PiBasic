...
stmtDRAWSPRITE:     DRAWSPRITE numExpr COMMA numExpr COMMA numExpr COMMA numExpr COMMA numExpr COMMA numExpr ;
...
FN_INTEGER        : FN PNAME PERCENT ;
FN_FLOAT          : FN PNAME ;
FN_STRING         : FN PNAME DOLLAR ;
VARIABLE_FLOAT    : NAME ;
VARIABLE_INTEGER  : NAME PERCENT ;
VARIABLE_STRING   : NAME DOLLAR ;
VARIABLE_TYPE   : NAME '!' ;
HEXNUMBER       : '&' [0-9A-Fa-f]+ ;
