...
public:
    DARICException(ErrorLocation location, std::string filename, UINT32 line_number, UINT32 raw_line_number, short char_position, std::string error)
